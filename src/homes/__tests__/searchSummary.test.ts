...
describe("the homes resource #summary", () => {
  ...
  it("should call the search endpoint", () => {
    expect(mockFetch.mock.calls[0][0]).toBe(
      "http://localhost:3000/api/v1/mobile_homes/?listing_type_id%5B%5D=1&max_price=100000&min_price=50000&num_bathrooms%5B%5D=2&num_bedrooms%5B%5D=3&detail_level=SUMMARY"
    )
  })
